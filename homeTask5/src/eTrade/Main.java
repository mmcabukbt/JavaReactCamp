...
//invalid password error>> Password field can not be less 6 digits..		
		System.out.println(userManager.add(new User("Ayþe", "Bilir", "", "dene@bilir.com")).message);
		System.out.println(userManager.add(new User("Ayþe", "", "123456", "dene@bilir.com")).message);
		System.out.println(userManager.add(new User("Ayþe", "Bilir", "0000:)", "ç.öç.öe.dene@bilir.com")).message);
		System.out.println(userManager.add(new User("Ayþe", "Bilir", "12345", "dene@bilir.com")).message); //*/
/*/invalid user first last name error>> User First Name and Last Name; can not be Emty or less 2 letters...
		...
		System.out.println(userManager.add(new User("Ayþe", "Bilir", "123456", "dene@bilir.com")).message);
		System.out.println(userManager.add(new User("Ayla", "Bilir", "123456", "adene@gmail.com")).message);
		System.out.println(userManager.add(new User("Ömer", "Halisdemir", "123456", "omerhalisdemir@sehit.com")).message);
